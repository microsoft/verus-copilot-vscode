...
class LLM:
    ...
    def infer_llm(self, engine, instruction, exemplars, query, system_info=None, answer_num=1, max_tokens=2048, temp=0.7, json=False, return_msg=False, verbose=False):
        """
        Args:
            instruction: str
        ...
        system_info = "You are a helpful AI assistant." if system_info is None else system_info
